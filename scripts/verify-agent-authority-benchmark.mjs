...
for (const phrase of [
  ...
  "surface=openai_codex_coding_authority",
  "surface=chrome_devtools_mcp_browser_authority",
  "surface=claude_code_templates_agent_authority",
  "surface=oh_my_claudecode_multi_agent_authority",
  "surface=beads_agent_memory_authority",
  "surface=byterover_agent_memory_authority",
  "surface=tencentdb_agent_memory_authority",
  "surface=hindsight_agent_memory_authority",
  "surface=agentops_eval_authority_gap",
  "surface=raga_catalyst_agent_observability_authority",
  "surface=composio_agent_orchestrator_authority",
  "surface=openagentscontrol_approval_execution_authority",
