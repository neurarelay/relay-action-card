...
- Live OpenAI client verification still requires provider credentials and controlled Neura MCP access in the local verification environment. Claude Messages API live proof passed privately on May 9; Claude Code client verification remains pending.
